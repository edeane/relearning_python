...
It will link you right my code documentation for it. Link to example google :mod:`test_py_module.example_google`.
...
In this paragraph I am going to link to Google so that it opens in a new tab |location_link|.
